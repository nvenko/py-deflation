...
- samplers.py : 
  ...
  - Assembles sampled operator ![](https://latex.codecogs.com/gif.latex?%5Cinline%20%5Cmathbf%7BA%7D%28%5Ctheta%29)for the stochastic system $\mathbf{A}(\theta)\mathbf{u}(\theta)=\mathbf{b}$ coming from a P0-FE discretization of the SDE $\partial_x[\kappa(x;\theta)\partial_xu(x;\theta)]=-f(x)​$. 
- solvers.py : 
