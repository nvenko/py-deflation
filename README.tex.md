...
fig, ax = pl.subplots(2, 4, figsize=(16,7.5))
# First row:
ax[0,0].set_title("(kdil,ell)")
ax[0,0].plot(dcgmo_kdim[("mc", "previous", 0)], label="dcgmo")
ax[0,0].plot(dcgmo_ell[("mc", "previous", 0)], label="dcgmo")
ax[0,1].set_title("Number of solver iterations, n_it")
ax[0,1].plot(dcgmo_it[("mc", "previous", 0)], label="dcgmo")
ax[0,2].set_title("Number of solver iterations, n_it")
ax[0,2].plot(dcgmo_it[("mcmc", "previous", 0)], label="dcgmo")
ax[0,3].set_title("(kdil,ell)")
ax[0,3].plot(dcgmo_kdim[("mcmc", "previous", 0)], label="dcgmo")
ax[0,3].plot(dcgmo_ell[("mcmc", "previous", 0)], label="dcgmo")
# Second row
ax[1,0].plot(dcgmo_kdim[("mc", "previous", 0)], label="dcgmo")
ax[1,0].plot(dcgmo_ell[("mc", "previous", 0)], label="dcgmo")
ax[1,1].plot(dcgmo_it[("mc", "previous", 0)], label="dcgmo")
ax[1,2].plot(dcgmo_it[("mcmc", "previous", 0)], label="dcgmo")
ax[1,3].plot(dcgmo_kdim[("mcmc", "previous", 0)], label="dcgmo")
ax[1,3].plot(dcgmo_ell[("mcmc", "previous", 0)], label="dcgmo")
for j in range(4):
  ax[0,j].set_xlabel("Realization index, t")
  for i in range(2):
  	ax[i,j].grid()
#ax[0].set_ylabel("Number of solver iterations, n_it")
fig.suptitle("DCGMO")
